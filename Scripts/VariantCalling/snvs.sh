...
###################################################################################################
#/omics/./bwa06_1KGRef_PhiX
#project/ODCF/./hs37d5_PhiX.fa
export REFGENOME_DIR="/omics/./bwa06_1KGRef_PhiX"
...
# export REFGENOME_DIR="/omics/./Reference_Genome/${refgenome}"
# REFFASTA=$(find "$REFGENOME_DIR" -name "*.primary_assembly.fa")
# export REFFASTA
export PROGRAM_DIR="/omics/./SequenceAlignment"
...
scriptdir=/omics/./Scripts/VariantCalling
subscriptdir="${scriptdir}/subscripts_snvs"
